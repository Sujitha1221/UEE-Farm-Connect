...
class ViewCurrentBiddingPage extends StatefulWidget {
  ViewCurrentBiddingPage({Key? key}) : super(key: key);

  @override
  _VCBPScreenState createState() => _VCBPScreenState();
}

class _VCBPScreenState extends State<ViewCurrentBiddingPage> {
  ...
  Future<List<Map<String, dynamic>>?> getAllBidding(
    ...
    try {
      ...
      final response = await client.get(
        Uri.parse('http://192.168.1.6:8080/bidding/get-pending-user/$userName'),
