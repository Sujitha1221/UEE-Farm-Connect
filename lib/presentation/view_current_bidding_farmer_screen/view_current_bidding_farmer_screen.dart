...
class ViewCurrentBiddingFarmerPage extends StatefulWidget {
  ViewCurrentBiddingFarmerPage({Key? key}) : super(key: key);

  @override
  _VCBFPScreenState createState() => _VCBFPScreenState();
}

class _VCBFPScreenState extends State<ViewCurrentBiddingFarmerPage> {
  ...
  Future acceptBidding(BiddingF bidding) async {
  ...
  Future rejectBidding(BiddingF bidding) async {
    print(bidding.farmerUserName + " " + bidding.productName);
    try {
